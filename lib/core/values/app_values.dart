...
abstract class AppValues {
  static const Widget spaceH5 = SizedBox(height: 5);
  static const Widget spaceH10 = SizedBox(height: 10);
  static const Widget spaceH15 = SizedBox(height: 15);
  static const Widget spaceH20 = SizedBox(height: 20);
  static const Widget spaceH25 = SizedBox(height: 25);
  static const Widget spaceH30 = SizedBox(height: 30);
  static const Widget spaceH35 = SizedBox(height: 35);
  static const Widget spaceH45 = SizedBox(height: 45);

  static const Widget spaceW5 = SizedBox(width: 5);
  static const Widget spaceW10 = SizedBox(width: 10);
  static const Widget spaceW15 = SizedBox(width: 15);
  static const Widget spaceW20 = SizedBox(width: 20);
  static const Widget spaceW25 = SizedBox(width: 25);
  static const Widget spaceW30 = SizedBox(width: 30);
  static const Widget spaceW35 = SizedBox(width: 35);
  static const Widget spaceW45 = SizedBox(width: 45);
