...
abstract class AppColors {
  static const Color primaryColor = Color(0xFFFAFBFD);
  static const Color cardColorLight = Color.fromARGB(255, 243, 242, 255);
  static const Color cardColorDark = Color.fromARGB(255, 50, 50, 75);
